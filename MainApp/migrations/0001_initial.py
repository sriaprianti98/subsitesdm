...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nm_laporan', models.CharField(max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Kategori',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kategori_faq', models.CharField(max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Kelompok',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('misi', models.CharField(max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='ProfilKaro',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visipom', models.CharField(default='Some String', max_length=200)),
                ('bpomis', models.CharField(default='Some String', max_length=500)),
                ('nm_kelompok', models.CharField(max_length=100)),
                ('kelompok_id', models.ManyToManyField(to='MainApp.Kelompok')),
                ('misipom', models.ManyToManyField(to='MainApp.MisiBPOM')),
                ('profilkaro', models.ManyToManyField(to='MainApp.ProfilKaro')),
                ('tugaspom', models.ManyToManyField(to='MainApp.TugasBPOM')),
            ],
        ),
        migrations.CreateModel(
            name='Pelayanan',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tahun_laporan', models.CharField(max_length=100)),
                ('dokumen', models.FileField(upload_to='laporan')),
                ('jenislaporan_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='MainApp.jenislaporan')),
            ],
        ),
        migrations.AddField(
            model_name='kelompok',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('emailsdm', models.EmailField(default='@gmail.com', max_length=254)),
                ('directlink', models.URLField(default='link')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='MainApp.user')),
                ('detail_FAQ', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='MainApp.detailfaq')),
                ('kategori_FAQ', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='MainApp.kategorifaq')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='detailfaq',
            name='jawaban',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='MainApp.jawabanfaq'),
        ),
        migrations.CreateModel(
            name='Berita',
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='MainApp.user')),
                ('kategori_berita', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='MainApp.kategoriberita')),
            ],
        ),
        migrations.CreateModel(
            name='Beranda',
